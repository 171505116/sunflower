...
package com.yao.kotilondemo.adapter
...
import com.yao.kotilondemo.databinding.ListItemPlantBinding
import com.yao.kotilondemo.fragment.HomeViewPagerFragmentDirections

/**
 *
 * @ProjectName:    sunflower
 * @Package:        com.yao.kotilondemo.adapter
 * @ClassName:      PlantAdapter
 * @Description:     java类作用描述
 * @Author:         Anson
 * @CreateDate:     2020/4/9 13:53
 * @UpdateUser:     更新者：
 * @UpdateDate:     2020/4/9 13:53
 * @UpdateRemark:   更新说明：
 * @Version:        1.0
 */
...
class PlantViewHolder( private val binding :ListItemPlantBinding):RecyclerView.ViewHolder(binding.root){
    init{
        binding.setClickListener { binding.plant?.let { plant -> navigateToPlant(plant,it) } }
    }
